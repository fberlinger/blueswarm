...
class Vision():
    ...
    def __init__(self, max_blobs, img_r, img_l):
    ...
    def update(self):
        ...
        #t_now = time.time()
        self._blob_r.detect(self.img_r)
        #t_blob = time.time() - t_now

        # check left side
        
        self._blob_l.detect(self.img_l)
